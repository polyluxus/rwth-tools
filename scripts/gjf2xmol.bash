...
#
# gjf2xyz.bash -- 
#   a script to convert from coordinates in gjf format to xmol
...
if [[ -z $1 || "$1" == "-h" ]] ; then
  ...
  echo "___version___: 2019-08-00-0000"
  echo "License:       gjf2xyz.bash  Copyright (C) 2019  Martin C Schwarzer"
...
if [[ "$1" =~ ^[Ll][Ii][Cc][Ee][Nn][Ss][Ee]$ ]] ; then
  ...
  debug "Displayed license and will exit."
  exit 0
fi
